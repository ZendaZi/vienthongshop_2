                                    ...
                                    <div class="product__item col-lg-12">
                                        <div class="cart">
                                            <table class="table_cart">
                                                ...
                                                <span class="title_hoten"> Tên họ:</span>
                                                <span style="color: red;">*</span>
                                            

                                           
                                                <input type="text" name="uname" maxlength="60" placeholder="Tên họ" class="input_hoten">
                                                <br><br>
                                            
                                            
                                           
                                                <span class="title_điachi"> Địa chỉ:</span>
                                                <span style="color: red;">*</span>
                                            

                                           
                                                <textarea name="street" class="input_diachi" cols="40" rows="4" placeholder=" Địa chỉ"></textarea><br><br>
                                            
                                            
                                           
                                                <span class="title_sdt"> Số điện thoại:</span>
                                                <span style="color: red;">*</span>
                                           
                                            
                                           
                                                <input type="tel" name="tel" class="input_std" maxlength="20"><br><br>
                                                ...
                                                <input type="email" name="email" class="input_email" maxlength="100"><br><br>
                                               

                                            
                                                <span>Hình Thức Thanh Toán:</span><br>
                                                <input type="radio" name="paymenk" id="p_paymenk" value="p">
                                                <label>Thanh toán bằng chuyển khoản qua ngân hàng</label><br>
                                                <input type="radio" name="paymenk" checked="" id="u_paymenk" value="u">
                                                <label> Thanh toán bằng tiền mặt sau khi nhận hàng (COD)</label><br><br>
                                           
                                                
                                                   <button class="tb_dh">Xác Nhận Đặt Hàng</button>
